...
class Cust_dashboard extends CI_Controller {
    ...
    public function index() {
        ...
        $data['cust_service'] = $this->db->query("SELECT W.notes, I.name,W.status,W.work_rqst_id FROM work_request W JOIN item_service_tb I on I.item_id = W.item_id  WHERE W.cust_id =".$cust_id)->result();
