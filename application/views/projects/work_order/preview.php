...
<body> -->
    ...
    <h1 class="estimate-header">Work Order</h1>
    ...
    <div class="Work order-details col-sm-4 ms-auto text-end">
        <p>Work order number : <strong><?=$l->w_number?></strong>  </p>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="EstimateModalLabel">Work Order Preview</h5>
